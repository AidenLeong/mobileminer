...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String urlRegister =
      "https://justminedb.com/mobileminer/php/register_user.php";
  ...
  void _onRegister() {
    ...
    showDialog(
      ...
      builder: (context) => new AlertDialog(
        title: Text("Is your information is correct?", style: TextStyle(fontFamily:"Solway"),),
        content: new Text("Please confirm your information is correct.", style: TextStyle(fontFamily:"Solway")),
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
